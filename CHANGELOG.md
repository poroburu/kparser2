...
- Additional-effect HP drain (proc message 161, Bloody Bolt) is attacker recovery, not proc damage. Proc MP drain (162) and TP drain (165) stay off additional-effect damage. Souleater (message 100) is an effect id. Weapon Bash (message 110) is ability damage.
