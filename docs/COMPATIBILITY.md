...
|----------|----------|---------------|
| v0.1.0-rc.4 | v0.1.0-rc.1 | `kpacket.v1` |
| v0.1.0-rc.3 | v0.1.0-rc.1 | `kpacket.v1` |
| v0.1.0-rc.2 | v0.1.0-rc.1 | `kpacket.v1` |
| v0.1.0-rc.1 | v0.1.0-rc.1 | `kpacket.v1` |

## Version layers

- **Git tag** (`v0.1.0-rc.4`) — distribution and release notes. kpacket2 has no newer tag; live capture still uses kpacket2 `v0.1.0-rc.1` on the same wire. Ashita 4.3 `/load` needs kpacket2 `da68567` (`expDestroyPlugin`) until that plugin is tagged.
